...
public class GameInput : MonoBehaviour {
    ...
    private void Awake()
    {
        ...
        playerInputAction.Player.InteractAlternative.performed += InteractAlternate_performed;
    ...
    public string GetBindingText(Binding binding)
    {
        switch (binding)
        {
            ...
            case Binding.Gamepad_InteractAlternate:
                return playerInputAction.Player.InteractAlternative.bindings[1].ToDisplayString();
